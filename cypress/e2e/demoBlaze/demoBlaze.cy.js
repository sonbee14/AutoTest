...
describe("test", function () {
  ...
  it("test", () => {
    demoBlaze.getMenuDetails().then((text) => {
      cy.log("1");
      cy.log("2");
      cy.log("3");
      cy.log("4");
